...
public class MyOrderList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_list_pro);
        getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN,
                WindowManager.LayoutParams.FLAG_FULLSCREEN);

        searchView = findViewById(R.id.searchAbsen);
        session = new Session(this);
        avLoadingIndicatorView = findViewById(R.id.avilistpro);
        DatabaseReference rootRef = FirebaseDatabase.getInstance().getReference(LAUNDRY).child(ByOrder);
        ...
        recyclerView = findViewById(R.id.rcvuserpro);
            ...
            query.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    if (dataSnapshot.exists()){
                        ...
                        laundryAdapter = new LaundryAdapter(MyOrderList.this,dataLaundries);
    ...
    private void cari(String newText) {
        ...
        if (dataLaundries!=null){
            ...
            laundryAdapter = new LaundryAdapter(MyOrderList.this,searchList);
            recyclerView.setAdapter(laundryAdapter);
            laundryAdapter.notifyDataSetChanged();
            recyclerView.setVisibility(View.VISIBLE);
            laundryAdapter.setOnItemClickListener(position -> {
                Intent intent = new Intent(MyOrderList.this,DetailUser.class);
    ...
    public void onBackPressed() {
        Intent intentHome = new Intent(MyOrderList.this, MainActivity.class);
